...
(Screenshot: Hyper-V Memory Configuration)
...
(Screenshot: AD DS Installation Summary)
...
(Screenshot: Deployment Configuration Wizard)
...
(Screenshot: DNS Manager Forward & Reverse Zones)  
(Screenshot: nslookup Validation)
...
(Screenshot: Clean OU Structure)  
(Screenshot: Group Membership View)
...
(Screenshot: Domain Joined System Properties)  
